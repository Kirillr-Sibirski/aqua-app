...
Source: `refs/aqua/src/Aqua.sol`, `refs/aqua/src/interfaces/IAqua.sol`, `refs/swap-vm/src/*`, summarised in `kb/aqua-core.md` and `kb/swapvm-core.md`.
