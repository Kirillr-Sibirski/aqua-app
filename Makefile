...
#   make test-surface    SurfaceLens (Foundry) + the read path against the fork (vitest)
#
...
# The read layer's own tests: the lens in Foundry, then the path the screen runs, against the fork.
test-surface:
